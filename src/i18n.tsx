...
const copy = {
  hy: {
    ...
    deleted: 'Ընթացքը ջնջվեց', undo: 'Հետ բերել', restarted: 'Հաշվարկը սկսվեց նորից', milestoneSaved: 'Նպատակը պահված է', nextGoal: 'Հաջորդ նպատակը',
    ...
    progressEyebrow: 'Առաջընթաց', yourJourneys: 'Քո ընթացքները', progressIntro: 'Բացիր քարտը՝ նպատակները, փոփոխություններն ու խնայած գումարը տեսնելու համար։',
  ...
  en: {
    ...
    progressEyebrow: 'Progress', yourJourneys: 'Your journeys', progressIntro: 'Open a card to see goals, health changes, and money saved.',
